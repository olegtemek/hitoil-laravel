          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="row col-sm-12 input-group">
                ...
                <input type="text" class="form-control" id="oil_file" name="oil_file" value="{{ $factory->oil_file }}">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="row col-sm-12 input-group">
                ...
                <input type="text" class="form-control" id="petrol_file" name="petrol_file" value="{{ $factory->petrol_file }}">
                <div class="input-group-prepend">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="row col-sm-12 input-group">
                ...
                <input type="text" class="form-control" id="all_file" name="all_file" value="{{ $factory->all_file }}">
                <div class="input-group-prepend">
